...
extern void OLED_ShowChar(u8 x,u8 y,u8 chr);       //显示字符
extern void OLED_ShowNum(u8 x,u8 y,u32 num,u8 len,u8 size2);          //显示数字变量 
extern void OLED_ShowString(u8 x,u8 y, u8 *p);	         //显示字符串	
extern void OLED_Set_Pos(unsigned char x, unsigned char y);
extern void OLED_ShowCHinese(u8 x,u8 y,u8 no);         //显示汉字
